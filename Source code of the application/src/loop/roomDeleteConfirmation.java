 ...
 * @author Frank
 */
public class roomDeleteConfirmation extends javax.swing.JFrame {
    ...
    */
     ...
     {
         try{
            String sql = "DELETE FROM `each_room` WHERE `room_no` ='"+roomNo +"'";
    ...
    public roomDeleteConfirmation() {
        initComponents();
    }
    public String RoomNo;
     public roomDeleteConfirmation(String pop, Connection con) {
        initComponents();
        this.setLocationRelativeTo(null);
        cn = con;
        RoomNo = pop;
        selectedRoom_textbox.setText(pop);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(roomDeleteConfirmation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new roomDeleteConfirmation().setVisible(true);
            }
        });
    }
