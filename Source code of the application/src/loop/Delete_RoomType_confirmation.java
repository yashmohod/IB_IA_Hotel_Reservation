 ...
 * @author Frank
 */
public class Delete_RoomType_confirmation extends javax.swing.JFrame {
    ...
    {
         try{
            String sql = "DELETE FROM `rooms` WHERE `Room_type` ='"+roomtype +"'";
    ...
    public void deleterooms(String roomtype)
    {
         try{
            String sql = "DELETE FROM `each_room` WHERE `room_type` ='"+roomtype +"'";
            PreparedStatement ps = cn.prepareStatement(sql);
            boolean rs = ps.execute();
            if (rs){System.out.println("done");}
        }
    ...
    public Delete_RoomType_confirmation() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    public String roomtype_ ;
    public Delete_RoomType_confirmation(String RoomType, Connection con) {
        initComponents();
        cn = con;
        this.setLocationRelativeTo(null);
        roomtype_= RoomType;
        selectedRoom_textbox.setText(RoomType);
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("**With the room type all the other**\n deatils related will also be deleted ");
    ...
    private void delete_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_buttonActionPerformed
        // TODO add your handling code here:
        deleteroomType(roomtype_);
        deleterooms(roomtype_);
        new add_remove_roomTypes (cn, true).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_RoomType_confirmation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_RoomType_confirmation().setVisible(true);
            }
        });
    }
